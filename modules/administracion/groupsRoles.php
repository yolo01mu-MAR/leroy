  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading clearfix">
      <strong>
       ...
       <a href="add_group.php" class="btn btn-roy pull-right btn-sm"> Agregar Rol</a>
    </div>
        ...
        <?php foreach($all_groups as $a_group): ?>
          <tr>
           ...
           <td class="text-center">
             <?php
               echo ($a_group['group_level'] == 1) ? '1 - ALTO' :
                   (($a_group['group_level'] == 2) ? '2 - MEDIO' :
                   (($a_group['group_level'] == 3) ? '3 - BAJO' :
                   remove_junk($a_group['group_level'])));
             ?>
           </td>
           <td class="text-center">

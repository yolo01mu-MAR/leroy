<?php
  $page_title = 'Entrada de Material';
...
<div class="row">
    <div class="col-md-12 entrada-container">

        <div class="entrada-header">
            <div>
                <h1>Entrada de material</h1>
                <p>Registra el material que ingresa al almacén y actualiza el inventario</p>
            </div>
            <span class="entrada-tag">
        ...
        <form id="formEntrada" method="POST">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="motivo" required>
                                ...
                                <option value="Devolucion de cliente">Devolución de cliente</option>
                                <option value="Produccion terminada">Producción terminada</option>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                class="form-control"
                                name="referencia"
                                placeholder="No. de factura, remisión del proveedor...">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                name="observaciones"
                                placeholder="Notas adicionales sobre esta entrada (opcional)"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="resumen-strip">
                ...
                <div class="resumen-item">
                    <div class="label">Piezas totales a ingresar</div>
            ...
            <div class="card-panel">
                ...
                <div class="tabla-detalle-wrap">
                    ...
                    <p class="detalle-vacio" id="detalleVacio">Aún no has agregado productos a esta entrada.</p>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
     ...
     * autocomplete de producto, muestra el stock actual al
     * seleccionar el producto y calcula el stock resultante
     * (stock_actual + cantidad) en vivo.
     *
                    ...
                    .then(function (data) {
                        ...
                        if (!data || data.length === 0) {
                            resultados.innerHTML =
                                ...
                                '<div class="autocomplete-item" style="cursor:default;"><small>¿Es un producto nuevo? Dalo de alta primero en el catálogo.</small></div>';
    ...
    function actualizarStockResultante(fila) {
        ...
        span.textContent = stockActual + cantidad;
    }
    ...
    form.addEventListener('submit', function (e) {
        ...
        if (filas.length === 0) {
            e.preventDefault();
            alert('Agrega al menos un producto antes de guardar la entrada.');
            return;
        }

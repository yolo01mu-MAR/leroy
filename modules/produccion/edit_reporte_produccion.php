  ...
  <div class="col-md-12">
    ...
    <div class="panel-heading encabezado-reporte">
      ...
      <div class="control-guardado">
          <!-- BOTÓN GUARDAR -->
          <button id="btnGuardar" class="icon-btn" onclick="guardarManual()" title="Guardar">
              💾
          </button>
          <!-- SWITCH AUTOGUARDADO -->
          <label class="switch" title="Autoguardado">
              <input type="checkbox" id="autoSwitch" checked onchange="toggleAuto()">
              <span class="slider"></span>
          </label>
          <!-- INDICADOR -->
          <span id="estadoDot" class="estado-dot gris"></span>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="text-right" style="margin-top:15px;">
                  <button type="button" id="btnFinalizar" class="btn btn-success btn-finalizar" disabled>
                    <i class="glyphicon glyphicon-ok"></i> Finalizar Reporte
                  </button>
                </div>
              </div>
            </div>

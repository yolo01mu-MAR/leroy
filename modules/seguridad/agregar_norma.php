...
<div class="edit-norma-container">
    ...
    <form method="POST" action="guardar_norma.php" enctype="multipart/form-data" id="formAgregarNorma">

        <!-- DATOS GENERALES Y PORTADA -->
        <div class="card-panel">
            <div class="edit-header-top">
                <a href="normas.php" class="btn-volver-header">
                    <span class="glyphicon glyphicon-arrow-left"></span>
                    <span>Volver a la lista de normas</span>
                </a>
                <span class="header-status-tag">
                    <span class="status-dot"></span> Modo Agregar
                </span>
            </div>
            ...
            <div class="preview-card">
                <div class="preview-thumb">
                    <?php $foto_default = BASE_URL . '/uploads/normas/no_image.jpg'; ?>
                    <span class="glyphicon glyphicon-picture" id="preview-live-icon" style="font-size:20px; color:#94a3b8;"></span>
                    <img src="<?php echo $foto_default; ?>" id="preview-live-img" style="display:none;" alt="Portada">
                </div>
                <div class="preview-info">
                    <span class="preview-codigo" id="preview-codigo">NOM-000-STPS-0000</span>
                    <div class="preview-nombre" id="preview-nombre">Nombre de la norma</div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="input-codigo" name="codigo_norma" class="form-control" placeholder="Ej: NOM-001-STPS-2008" required>
                    </div>
                </div>
                ...
                <div class="col-md-5 col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="input-nombre" name="nombre_norma" class="form-control" placeholder="Ej: Edificios, locales, instalaciones y áreas..." required>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_clasificacion" id="input-clasificacion" class="form-control" required>
                            ...
                            <?php foreach ($clasificaciones as $c): ?>
                                <option value="<?php echo $c['id']; ?>" data-nombre="<?php echo remove_junk(strtolower($c['nombre'])); ?>">
                ...
                <div class="col-md-12">
                    ...
                    <div class="img-upload-row">
                        <div class="img-preview">
                            ...
                            <img src="<?php echo $foto_default; ?>" id="preview-img" style="display:none;" alt="Portada">
                        </div>
        ...
        <div class="actions-bar">
            <span class="contador-puntos">
                <strong id="contadorPuntosNum">0</strong> requisito(s) en este formulario
            </span>
            <div>
                <a href="normas.php" class="btn btn-default">
                    Cancelar
                </a>
                <button type="submit" name="guardar_norma" class="btn btn-primary btn-guardar">
                    <span class="glyphicon glyphicon-floppy-disk"></span> Guardar norma
                </button>
            </div>
        </div>

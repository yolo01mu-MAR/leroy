...
$estatus_filtro = $_GET['estatus'] ?? 'PENDIENTE_RH';
...
<script>
    window.usuarioRhId = <?= (int)$_SESSION['user_id']; ?>;
</script>
...
<script src="<?= BASE_URL ?>/firmas/vacaciones/assets/js/firma_vacaciones_rh.js"></script>

...
if (isset($_POST['btnGestion'])) {
    ...
    redirect("ticket_detalle.php?id=".$id, false);
}
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="tk-header" style="--tk-priority-color: <?php echo htmlspecialchars($priorityColor); ?>;">
            <div class="row">
                <div class="col-md-8">
                    <a href="ticket_historial.php" class="btn btn-default btn-xs" style="margin-bottom:10px;">
            ...
            <div class="tk-card-body">
                <form method="post">
                    <div class="tk-gestion-row">
                        ...
                        <div class="tk-gestion-col">
                            <button type="submit" name="btnGestion" class="btn btn-success">
            ...
            <div class="tk-card-body">
                ...
                <?php if (!empty($comentarios)): ?>
                    <?php foreach ($comentarios as $comentario): ?>
                        ...
                        ?>
                        <div class="tk-clearfix">
                            <div class="tk-avatar agent"><?php echo $avatar; ?></div>
                            <div class="tk-media-body">
                                <strong><?php echo remove_junk($comentario['name']); ?></strong>
                                <span class="label label-success" style="font-weight:400;">Sistemas</span>
                                <?php if (!empty($comentario['requiere_respuesta'])): ?>
                ...
                <form method="post">
                    ...
                    <div class="text-right">
                        <button type="submit" name="btnGuardarComentario" class="btn btn-primary">
                            <span class="glyphicon glyphicon-send"></span> Guardar actualización
                        </button>
                    </div>
                </form> -->
            </div>
